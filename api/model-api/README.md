...
Model API works together with settings configured in Vectary Studio. Most visual aspects are set up in the editor, while the API lets you control and modify them programmatically. Learn more about these concepts in [<mark style="color:blue;">Core Concepts</mark>](core-concepts.md).
...
<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-cover data-type="image">Cover image</th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Quick Start</strong></td><td><mark style="color:$info;">Step-by-step setup - from iframe to first API call</mark></td><td><a href="../../.gitbook/assets/Frame 1.png">Frame 1.png</a></td><td><a href="quick-start.md">quick-start.md</a></td></tr><tr><td><strong>Core Concepts</strong></td><td><mark style="color:$info;">Key concepts for understanding the API and Vectary Studio</mark></td><td><a href="../../.gitbook/assets/Frame 1.png">Frame 1.png</a></td><td><a href="core-concepts.md">core-concepts.md</a></td></tr><tr><td><strong>API Reference</strong></td><td><mark style="color:$info;">Methods by category with signatures, examples, and types</mark></td><td><a href="../../.gitbook/assets/Frame 1.png">Frame 1.png</a></td><td><a href="api-reference/">api-reference</a></td></tr><tr><td><strong>Ecommerce</strong></td><td><mark style="color:$info;">Patterns for online stores (Shopify, Webflow, Custom)</mark> </td><td><a href="../../.gitbook/assets/Frame 1.png">Frame 1.png</a></td><td><a href="ecommerce/">ecommerce</a></td></tr></tbody></table>
