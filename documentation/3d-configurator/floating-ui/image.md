...
Playback control of animated files and videos within the Floating UI can be managed through **interactions -** [animated-texture.md](../interactions/actions/animated-texture.md "mention")
