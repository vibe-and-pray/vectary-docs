...
{% hint style="info" %}
Selecting the same texture in the [Emission](materials-and-textures/basic-materials/emission.md) property as in [Color](materials-and-textures/basic-materials/color.md) makes the decal appear bright and unaffected by scene lighting.
{% endhint %}
